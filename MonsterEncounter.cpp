...
void MonsterEncounter::fourSecTimmer() {
    seconds = 4;
    RemoveTime();
}

void MonsterEncounter::WhenTimerRunsOut() {
    if (seconds < 1) {
...
void MonsterEncounter::RemoveTime() {
    BiliSeconds--;
    if (BiliSeconds < 1) {
        seconds--;

        BiliSeconds = 850000000;
...
void MonsterEncounter::ClearScreen() {
    system("CLS");
}